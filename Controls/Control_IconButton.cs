namespace Kenedia.Modules.BuildsManager.Controls
{
    ...
    public class Control_AddButton : Control
    {
        ...
        public Control_AddButton()
        {
            ...
            this.Texture = BuildsManager.ModuleInstance.TextureManager.getControlTexture(ControlTexture.Add);
            this.TextureHovered = BuildsManager.ModuleInstance.TextureManager.getControlTexture(ControlTexture.Add_Hovered);
